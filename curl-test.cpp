...
)
{
    ...
    std::unique_ptr<HttpSimple> httpToken (new HttpSimple("http://192.168.2.1:/GetToken", NULL, "{\"param1\":\"value1\",\"param2\":\"value2\"}\n", false));
    ...
    std::unique_ptr<HttpSimple> httpPartInfo (new HttpSimple("http://192.168.2.1:/GetInfo", "Authorization: Bearer code-here", "{\"param1\":\"value1\",\"param2\":\"value2\"}\n", true));
